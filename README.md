# eastwind
    eastwind是一个有趣的SOA框架(半成品，供学习交流)，基于netty实现，包含二进制/HTTP RPC、EventBus、多种负载均衡、重定向功能。
...
#### 6-1自动发现
    ...
    对于[EventBus](#2-EventBus)中的例子，builder.withFixedServers(":11111,:12222,:13333,:14444")，无须写全所有地址，只要同组服务节点之间有链路，所有节点都能互相发现。内部通过选举-广播实现。
